       ...
       <div class="sider">
         <logo></logo>
          ...
          <div class="history-list">
            ...
            <el-scrollbar>
                <div class="history-list-item" v-for="(item,index) in historyList" :key="item.id" @click="FindMessages(item.id)" :class="{active:item.id==chat_id}">
             <div class="history-icon"><el-icon class="icon"><ChatDotRound /></el-icon></div>
    ...
    />
          ...
          <div class="content">
            <div v-for="message in messages" :key="message.id">
               <div  class="message">
               <el-icon><User /></el-icon><span> : {{ message.user_input }}</span>

               </div>
               <div class="message">
                <el-icon><Printer /></el-icon><span> : {{ message.gpt_response }}</span>
             </div>
...
import {getChatHitoryList,getChatMessages} from "@/api/chatHistory"
